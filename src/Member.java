public class Member extends Induk {
    ...
    public Member(String nama, String ktp, String telp, String alamat) {
    ...
    public void printInfo() {
        ...
        System.out.println("Jenis Anggota\t:Member");
        System.out.println("Jumlah pesan kamar (maks 5):" + getJumlahKamar());
        rincianKamar();
        ...
        rincianFasilitas();
        System.out.println("Tambahan Pesan Fasilitas: Sauna 6");
        tambahanFasilitas();
