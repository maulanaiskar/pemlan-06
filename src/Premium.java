public class Premium extends Induk {
    ...
    public Premium(String nama, String ktp, String telp, String alamat) {
    ...
    public double getDiskon() {
        if (getHari() == 0) {
            return getBiayaKamar() * 0.1;
        } else {
            return getBiayaKamar() * 0.05;
        }
    }
    ...
    public void rincianMakan() {
        ...
        System.out.println("2. Lunch: " + jmlOrang + " (Free)");
        System.out.println("3. Dinner: " + jmlOrang + " (Free)");
    }
    ...
    public void printInfo() {
        ...
        System.out.println("Jumlah pesan kamar (tidak dibatasi):" + getJumlahKamar());
        rincianKamar();
        ...
        rincianFasilitas();
        System.out.println("Tambahan Pesan Fasilitas: Tidak ada");
